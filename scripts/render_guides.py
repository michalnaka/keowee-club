...
{sources}
  ...
  <section class="dispatch" id="dispatch">
    <div class="dispatch-inner">
      <p class="eyebrow">Thursday afternoon · One useful lake email</p>
      <h2>The Dock <em>Dispatch</em></h2>
      <p>Fresh conditions, a few weekend plans worth making, and places worth going around Keowee and Jocassee. Free, local, and weekly in season.</p>
